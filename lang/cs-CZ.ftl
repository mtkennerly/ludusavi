...
total-games = Hry
file-size = Velikost
file-location = Umístění
overall = Overall
status = Stav
cli-unrecognized-games = Žádné informace pro tyto hry:
cli-unable-to-request-confirmation = Nepovedlo se získat potvrzení.
