...
backup-is-newer-than-current-data = La sauvegarde existante est plus récente que les données actuelles.
backup-is-older-than-current-data = La sauvegarde existante est plus ancienne que les données actuelles.
