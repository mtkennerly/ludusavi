...
impl ToString for Language {
    fn to_string(&self) -> String {
        match self {
            Self::Arabic => "العربية (61%)",
            Self::ChineseSimplified => "中文（简体） (62%)",
            Self::Dutch => "Nederlands (24%)",
            Self::English => "English",
            Self::Esperanto => "Esperanto (21%)",
            Self::Filipino => "Filipino (39%)",
            Self::French => "Français (95%)",
            Self::German => "Deutsch (96%)",
            Self::Italian => "Italiano (62%)",
            Self::Japanese => "日本語 (53%)",
            Self::Korean => "한국어 (32%)",
            Self::Polish => "Polski (62%)",
            Self::PortugueseBrazilian => "Português brasileiro (92%)",
            Self::Russian => "Русский язык (19%)",
